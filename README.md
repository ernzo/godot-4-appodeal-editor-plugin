...
They consists of a lean core SDK (com.appodeal.ads:sdk:...) and separate dependencies for each ad network adapter (com.appodeal.ads.sdk.networks:admob:..., etc.).
...
# Original Notes:
# (Work In Progress!) Appodeal Plugin for Godot 4
