...
func _connect_signals():
	if !_instance:
		return
	# Corrected syntax using Callable for Godot 4
	_instance.connect("on_initialization_finished", Callable(self, "_on_initialization_finished"))
	_instance.connect("on_ad_revenue_received", Callable(self, "_on_ad_revenue_received"))
	_instance.connect("on_inapp_purchase_validate_success", Callable(self, "_on_inapp_purchase_validate_success"))
	_instance.connect("on_inapp_purchase_validate_fail", Callable(self, "_on_inapp_purchase_validate_fail"))
	_instance.connect("on_mrec_loaded", Callable(self, "_on_mrec_loaded"))
	_instance.connect("on_mrec_failed_to_load", Callable(self, "_on_mrec_failed_to_load"))
	_instance.connect("on_mrec_shown", Callable(self, "_on_mrec_shown"))
	_instance.connect("on_mrec_show_failed", Callable(self, "_on_mrec_show_failed"))
	_instance.connect("on_mrec_clicked", Callable(self, "_on_mrec_clicked"))
	_instance.connect("on_mrec_expired", Callable(self, "_on_mrec_expired"))
	_instance.connect("on_banner_loaded", Callable(self, "_on_banner_loaded"))
	_instance.connect("on_banner_failed_to_load", Callable(self, "_on_banner_failed_to_load"))
	_instance.connect("on_banner_shown", Callable(self, "_on_banner_shown"))
	_instance.connect("on_banner_show_failed", Callable(self, "_on_banner_show_failed"))
	_instance.connect("on_banner_clicked", Callable(self, "_on_banner_clicked"))
	_instance.connect("on_banner_expired", Callable(self, "_on_banner_expired"))
	_instance.connect("on_interstitial_loaded", Callable(self, "_on_interstitial_loaded"))
	_instance.connect("on_interstitial_failed_to_load", Callable(self, "_on_interstitial_failed_to_load"))
	_instance.connect("on_interstitial_shown", Callable(self, "_on_interstitial_shown"))
	_instance.connect("on_interstitial_show_failed", Callable(self, "_on_interstitial_show_failed"))
	_instance.connect("on_interstitial_clicked", Callable(self, "_on_interstitial_clicked"))
	_instance.connect("on_interstitial_closed", Callable(self, "_on_interstitial_closed"))
	_instance.connect("on_interstitial_expired", Callable(self, "_on_interstitial_expired"))
	_instance.connect("on_rewarded_video_loaded", Callable(self, "_on_rewarded_video_loaded"))
	_instance.connect("on_rewarded_video_failed_to_load", Callable(self, "_on_rewarded_video_failed_to_load"))
	_instance.connect("on_rewarded_video_shown", Callable(self, "_on_rewarded_video_shown"))
	_instance.connect("on_rewarded_video_show_failed", Callable(self, "_on_rewarded_video_show_failed"))
	_instance.connect("on_rewarded_video_clicked", Callable(self, "_on_rewarded_video_clicked"))
	_instance.connect("on_rewarded_video_finished", Callable(self, "_on_rewarded_video_finished"))
	_instance.connect("on_rewarded_video_closed", Callable(self, "_on_rewarded_video_closed"))
	_instance.connect("on_rewarded_video_expired", Callable(self, "_on_rewarded_video_expired"))
